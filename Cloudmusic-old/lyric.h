...
class Lyric: public QObject
{
    ...
    Q_PROPERTY(QList<int> timeStamp READ timeStamp WRITE setTimeStamp NOTIFY timeStampChanged)//时间戳
    Q_PROPERTY(QList<QString> plainLyric READ plainLyric WRITE setPlainLyric NOTIFY plainLyricChanged)
    Q_PROPERTY(int timeDif READ timeDif WRITE setTimeDif NOTIFY timeDifChanged)//时间差
public:
